...
////計時器變數////
timep time_game/*預設八個位置*/;//0:計時遊玩時間 1:玩家0落下時間計算(俄羅斯方塊) 2:玩家1落下時間計算(俄羅斯方塊) 3:玩家0移動計時(貪食蛇) 3:玩家1移動計時(貪食蛇) 4:
...
byte screen_out[2][3][20][20]={0};//[0:輸出畫面 1:暫停備分][0:R 1:G 2:B][y][x]畫面輸出
